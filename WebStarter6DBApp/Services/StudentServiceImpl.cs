...
namespace WebStarter6DBApp.Services
{
    public class StudentServiceImpl : IStudentService
    {
        ...
        public void UpdateStudent(StudentUpdateDTO studentUpdateDTO)
        {
            ...
            {
                _logger.LogError("Error. Student with id {Id} {Firstname} {Lastname} not updated. {ErrorMessage}",
        ...
        public void DeleteStudent(int id)
        {
            ...
            {
                _logger.LogError("Error. Student with id {id} could not be deleted. {ErrorMessage}",
                    id, ex.Message);
                throw;
            }
        }
        ...
        public StudentReadOnlyDTO GetStudent(int id)
        {
            ...
            {
                _logger.LogError("Error. Student with id {id} could not be returned. {ErrorMessage}",
                    id, ex.Message);
                throw;
            }
        }
